...
public class CartItemActivity extends AppCompatActivity {
    ...
    private TextView product_name, product_price, product_color, product_quantity ,product_total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product_color = (TextView) findViewById(R.id.cart_item_ProductColor);
